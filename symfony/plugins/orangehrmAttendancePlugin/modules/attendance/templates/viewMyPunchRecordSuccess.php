...
<?php echo javascript_include_tag(plugin_web_path('orangehrmAttendancePlugin', 'js/viewMyPunchRecordSuccess')); ?>

<div class="box">
    <div class="head">
        <h1><?php echo __('My Punch Records'); ?></h1>
    </div>
    <div class="inner">
        <div id="validationMsg">
            <?php echo isset($messageData) ? templateMessage($messageData) : ''; ?>
        </div>
        <form action="<?php echo url_for("attendance/viewPunchRecord"); ?>" id="reportForm" method="post">
            <fieldset>
                <ol class="normal">
                    <li>
