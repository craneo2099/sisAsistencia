...
class PunchService {
     ...
     */
    public function getPunchDao() {

        if (is_null($this->punchDao)) {
     ...
     * @return void
     */
    public function setPunchDao(PunchDao $punchDao) {
     ...
     */
    public function savePunchRecord(PunchRecord $punchRecord) {

        return $this->punchDao->savePunchRecord($punchRecord);
    }
    ...
    public function getLastPunchRecord($employeeId, $actionableStatesList) {
        ...
        return $this->getPunchDao()->getLastPunchRecord($employeeId, $actionableStatesList);
    }
    ...
    public function checkForPunchOutOverLappingRecords($punchInTime, $punchOutTime, $employeeId,$recordId) {
        ...
        return $this->getPunchDao()->checkForPunchOutOverLappingRecords($punchInTime, $punchOutTime, $employeeId,$recordId);
    }
    ...
    public function checkForPunchInOverLappingRecords($punchInTime, $employeeId) {
        return $this->getPunchDao()->checkForPunchInOverLappingRecords($punchInTime, $employeeId);
    }
    ...
    public function getSavedConfiguration($workflow, $state, $role, $action, $resultingState) {
        ...
        return $this->getPunchDao()->getSavedConfiguration($workflow, $state, $role, $action, $resultingState);
    }
     ...
     */
    public function getPunchRecord($employeeId, $date) {

        return $this->getPunchDao()->getPunchRecord($employeeId, $date);
    }
     ...
     * @return boolean
     */
    public function deletePunchRecords($punchRecordId) {

        return $this->getPunchDao()->deletePunhRecords($punchRecordId);
    }
     ...
     */
    public function getPunchRecordById($punchRecordId) {

        return $this->getPunchDao()->getPunchRecordById($punchRecordId);
    }
    ...
    public function checkForPunchInOverLappingRecordsWhenEditing($punchInTime, $employeeId,$recordId, $punchOut) {
        return $this->getPunchDao()->checkForPunchInOverLappingRecordsWhenEditing($punchInTime, $employeeId,$recordId, $punchOut);
    }
    ...
    public function checkForPunchOutOverLappingRecordsWhenEditing($punchIn, $punchOut, $employeeId,$recordId) {
        return $this->getPunchDao()->checkForPunchInOutOverLappingRecordsWhenEditing($punchIn, $punchOut, $employeeId, $recordId);
    }
     ...
     * @return array
     */
    public function searchPunchRecords($employeeId = null, $employeementStatus = null, $subDivision = null, $dateFrom = null , $dateTo = null ){
        return $this->getPunchDao()->searchPunchRecords($employeeId, $employeementStatus, $subDivision, $dateFrom, $dateTo );
    }
    ...
    {
        return $this->getPunchDao()->getLatestPunchInRecord($employeeId, $state);
    }
    ...
    public function getPunchRecordsBetweenTwoDays(string $fromDate, string $toDate,int $employeeId,string $state)
    {
        return $this->getPunchDao()->getPunchRecordsBetweenTwoDays($fromDate,$toDate,$employeeId,$state);
    }
     ...
     * @throws DaoException
     */
    public function getPunchRecordsByEmpNumbers($empNumbers, $dateFrom = null, $dateTo = null)
    {
        return $this->getPunchDao()->getPunchRecordsByEmpNumbers($empNumbers, $dateFrom, $dateTo);
    }
}
