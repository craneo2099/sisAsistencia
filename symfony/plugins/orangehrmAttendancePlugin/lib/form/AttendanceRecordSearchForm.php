...
class AttendanceRecordSearchForm extends sfForm {
    ...
    public function configure() {
        ...
        $datef = $this->getOption('dateFrom');
        $datet = $this->getOption('dateTo');
        ...
        $this->setWidgets(array(
            ...
            'dateFrom' => new ohrmWidgetDatePicker(array(), array('id' => 'attendance_from'), array('class' => 'formDateInput')),
            'dateTo' => new ohrmWidgetDatePicker(array(), array('id' => 'attendance_to'), array('class' => 'formDateInput'))
        ));

        if ($trigger) {
            $this->setDefault('employeeName', $this->getEmployeeName($employeeId));
            $this->setDefault('dateTo', set_datepicker_date_format($datet));
        }
        ...
        $this->setValidators(array(
            'dateFrom' => new ohrmDateValidator(array('date_format' => $inputDatePattern, 'required' => true),
                array('invalid' => 'Date format should be ' . $inputDatePattern)),
            'dateTo' => new ohrmDateValidator(array('date_format' => $inputDatePattern, 'required' => false),
                array('invalid' => 'Date format should be ' . $inputDatePattern)),
